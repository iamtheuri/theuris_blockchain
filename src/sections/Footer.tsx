const socialIcons = [
  ...
  },
  {
    ...
    href: 'https://github.com/iamtheuri',
  },
  {
    // LinkedIn
    icon: (
    ...
    href: 'https://www.linkedin.com/in/iamtheuri',
  },
  {
    // X
    icon: (
  ...
  },
  {
    ...
    href: 'https://www.instagram.com/iamtheuri_/',
  },
]
    ...
    <footer className="py-24 bg-zinc-950">
      <div className="container">
        ...
        <div className="mt-12 md:mt-48 md:flex justify-between items-center">
          <p className="text-zinc-400">&copy; iamtheuri 2025.</p>
          <div className="mt-4 md:mt-0 flex gap-6">
            {socialIcons.map((icon, iconIndex, href) => (
              <a
