...
export const HeroSection = () => {
  ...
  const cuboidRotate = useTransform(cuboidScrollYProgress, [0, 1], [30, -40]);

  return (
    <section className="py-24 md:py-52 overflow-x-clip">
      <div className="container">
        <p className="uppercase font-extrabold text-center text-zinc-500 tracking-wider">Introducing Blockforge</p>
        <h1 className="font-heading font-black text-5xl lg:text-7xl md:text-6xl text-center mt-4 max-w-3xl mx-auto">The Future of Blockchain is here.</h1>
