...
const cardData = [
  {
    ...
    title: 'Revolutionary Blockchain APIs',
    description: 'Effortlessly integrate and manage blockchain data with our cutting-edge API designed for seemless connectivity.',
    color: 'fuchsia',
  },
  {
  ...
  },
  {
    ...
    title: 'Seemless Blockchain Integration',
    description: 'Integrate blockchain seemlessly into your projects, with minimal efforts and maximum efficiency',
    color: 'violet',
  },
];
